...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::movie::set_movie_cover,
            commands::movie::clear_movie_cover,
            ...
            commands::music::set_music_cover,
            commands::music::regenerate_music_cover,
            commands::music::clear_music_cover,
            ...
            commands::file_explorer::get_known_folder_path,
            commands::file_explorer::open_file,
