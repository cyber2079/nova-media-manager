...
const shortcuts: { section: string; items: Shortcut[] }[] = [
  {
    section: "全屏 / 页面",
    items: [
      { keys: ["Ctrl", "K"], desc: "打开全局搜索", icon: <NeonIcon name="Search" size={16}><Search className="h-4 w-4" /></NeonIcon> },
      { keys: ["?"], desc: "显示此快捷键面板" },
      { keys: ["F11"], desc: "切换全屏", icon: <NeonIcon name="Maximize2" size={16}><Maximize2 className="h-4 w-4" /></NeonIcon> },
    ],
  },
  {
    section: "卡片操作",
    items: [
      ...
      { keys: ["点击 ☆"], desc: "收藏 / 取消收藏", icon: <NeonIcon name="Star" size={16}><Star className="h-4 w-4 text-yellow-400" /></NeonIcon> },
  ...
  },
  {
    ...
    items: [
      ...
      { keys: ["X", "或", "Esc"], desc: "退出批量模式", icon: <NeonIcon name="X" size={16}><X className="h-4 w-4" /></NeonIcon> },
    ],
  },
  {
    section: "设置",
    items: [
      { keys: ["点击 ⚙"], desc: "打开设置：语言、自启、主题", icon: <NeonIcon name="Settings" size={16}><Settings className="h-4 w-4" /></NeonIcon> },
    ],
  },
];
