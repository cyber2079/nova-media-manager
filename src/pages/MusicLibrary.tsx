                    ...
                    return (
                      <div key={id} className={cn("flex items-center gap-3 px-3 py-2 rounded-lg group transition-colors duration-300 cursor-pointer border", playing?.id === m.id ? "bg-primary/10 border-primary/20" : "bg-transparent border-transparent hover:bg-surface-lighter")}
                        ...
                        <div className="w-9 h-9 rounded overflow-hidden bg-surface-lighter shrink-0">
                          <img src={m.coverPath || "/themes/common/music.svg"} alt="" className="w-full h-full object-cover object-top scale-125" onError={(e) => { (e.target as HTMLImageElement).src = "/themes/common/music.svg"; }} />
                        </div>
                ...
                songsToAdd.map((m) => {
                  ...
                  return (
                    <div key={m.id}
                      ...
                      <div className="w-9 h-9 rounded overflow-hidden bg-surface-lighter shrink-0">
                        <img src={m.coverPath || "/themes/common/music.svg"} alt="" className="w-full h-full object-cover object-top scale-125"
      ...
      <div
        ...
        <div className="flex items-stretch gap-4">
          ...
          <div className="shrink-0 relative rounded overflow-hidden" style={{ width: 72 }}>
            <img src={playing.coverPath || "/themes/common/music.svg"} alt="" className="absolute inset-0 w-full h-full object-cover object-top scale-125"
              onError={(e) => { (e.target as HTMLImageElement).src = "/themes/common/music.svg"; }} />
          </div>
